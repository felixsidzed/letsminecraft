...
#define LMC_VECTOR_CHUNK_SIZE 4
...
namespace lmc {
	...
	public:
		...
		vector(uint32_t size = LMC_VECTOR_CHUNK_SIZE) : size(0), capacity(size), data((T*)::operator new(size * sizeof(T))) {};
	...
	private:
		void grow() {
			...
			uint32_t nc = capacity + LMC_VECTOR_CHUNK_SIZE;
